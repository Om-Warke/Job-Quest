...
import com.jobquest.backend.model.Recruiter;
import com.jobquest.backend.service.JobService;
import com.jobquest.backend.service.RecruiterService;
...
public class RecruiterController {
    ...
    public ResponseEntity<?> appendJob(@PathVariable String email, @RequestBody Job job) {
        try {

            Job savedJob = jobService.createJob(job);
            Recruiter updatedRecruiter = recruiterService.addJobToRecruiter(email, savedJob.getId());
            return new ResponseEntity<>(savedJob, HttpStatus.OK); // You return job object
        } catch (Exception e) {
            e.printStackTrace();
